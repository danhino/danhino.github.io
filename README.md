...
A modern, responsive personal portfolio website showcasing my experience as a Technical Program Manager specializing in enterprise integrations, API platforms, and FinTech solutions.
...
3. Update the GitHub username in the JavaScript config
4. Add your own resume files
5. Modify the favicon if desired
...
Built with vanilla HTML · Hosted on GitHub Pages · © 2026 Daniel Hinojosa